<x-app-layout title="Edit Equipment">
    <div class="max-w-2xl mx-auto px-4 py-10">
        ...
        <h1 class="text-2xl font-bold text-gray-900 mb-6">Edit: {{ $equipment->name }}</h1>

        <form action="{{ route('owner.equipment.update', $equipment) }}" method="POST" enctype="multipart/form-data"
            ...
            <div>
                ...
                <img src="{{ $equipment->image_url }}" class="w-40 h-28 object-cover rounded-xl border border-gray-200" alt="">
            </div>
            @endif
            ...
            <div>
                ...
                <input type="number" name="daily_rate" value="{{ old('daily_rate', $equipment->daily_rate) }}" min="1" step="0.01" required
                       class="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-sky-500">
            </div>
            ...
            <div>
                ...
                <textarea name="description" rows="3"
                          class="w-full border border-gray-200 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-sky-500">{{ old('description', $equipment->description) }}</textarea>
            </div>
